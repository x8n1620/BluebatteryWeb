...
<body>
   <table><tbody><tr>
      <td> <label for="searchdateInput">Filter Datum</label>
			  <input type="text" name="searchdateInput" id="searchdateInput" placeholder="(YYYY-MM-DD) or (KWxx)" class="form-control" /> </td> <!-- Suchfeld -->
